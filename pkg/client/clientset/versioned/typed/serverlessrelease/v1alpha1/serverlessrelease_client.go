...
import (
	...
	"github.com/serverless-operator/serverless-operator/pkg/client/clientset/versioned/scheme"
...
type ReleaseV1alpha1Interface interface {
	...
	ServerlessReleasesGetter
}

// ReleaseV1alpha1Client is used to interact with features provided by the release.serverless-operator group.
type ReleaseV1alpha1Client struct {
	restClient rest.Interface
}

func (c *ReleaseV1alpha1Client) ServerlessReleases(namespace string) ServerlessReleaseInterface {
	return newServerlessReleases(c, namespace)
}
